...
namespace SpotiffyWidget.Requests
{
    public static class ProfileRequests
    {
        ...
        public static async Task<List<Track>> GetTopTracksAsync(
            string accessToken,
            int trackCount,
        ...
        public static async Task<List<ProfileTrack>> GetTracksAsync(
            string accessToken,
            int trackCount,
            CancellationToken cancellationToken
        )
        ...
        // user's top artists
        public static async Task<List<Artist>> GetTopArtistsAsync(
            string accessToken,
            CancellationToken cancellationToken
        )
        {
            string url = SpotifyEndPoints.Profile.TopArtists;
            var artists = await SpotifyApiHelper.SendRequestAsync<Paging<Artist>>(
                url,
                accessToken,
                cancellationToken
            );
        ...
        // user's playlists
        public static async Task<List<Playlist>> GetUsersPlaylists(
            string accessToken,
            CancellationToken cancellationToken
        )
        {
